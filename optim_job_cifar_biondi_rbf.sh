...
#SBATCH --output=/common/home/projectgrps/CS704/CS704G1/MetaOptNet/sbatch_logs/CIFAR_FS_MetaOptNet_SVM_biondi_rbf/%u.%j.out
...
#SBATCH --job-name=metalearning_CIFAR_FS_MetaOptNet_SVM_biondi_rbf
...
# Run your command
srun python train.py --save-path "./experiments/CIFAR_FS_MetaOptNet_SVM_biondi_rbf/" --train-shot 5 --head SVM_RBF --network ResNet --dataset CIFAR_FS --num-epoch 30
