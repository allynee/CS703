...
#SBATCH --output=/common/home/projectgrps/CS704/CS704G1/MetaOptNet/sbatch_logs/CIFAR_FS_MetaOptNet_SVM_kw_rbf_loss_test/%u.%j.out
...
#SBATCH --mail-user=kokwee.loh.2020@scis.smu.edu.sg
#SBATCH --job-name=CIFAR_kw_rbf_loss_test
...
# Run your command
srun python train.py --save-path "./experiments/CIFAR_FS_MetaOptNet_SVM_kw_rbf_loss_test/" --train-shot 5 --head SVM_RBF --network ResNet --dataset CIFAR_FS --num-epoch 2
